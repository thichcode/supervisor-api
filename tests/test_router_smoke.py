...
EXTRACTED_ROUTE_PATHS = {
    ...
    "/chat/harness",
    "/webhook/feedback",
    "/webhook/feedback/style/{user_id}",
    "/webhook/n8n/actions",
    "/webhook/n8n/query",
    "/webhook/n8n/action/request",
    "/webhook/n8n/approvals/pending",
    "/webhook/n8n/approvals/{request_id}",
    "/webhook/n8n/approvals/{request_id}/approve",
    "/webhook/n8n/approvals/{request_id}/reject",
    "/knowledge/stats",
    "/knowledge/search",
