...
class KBCategoryTemplateMapper:
    ...
    def _generic_variants(cls, query: str) -> list[str]:
        ...
        synonym_map = {
            ...
            "issue": ["problem", "error", "lỗi", "ticket"],
            "problem": ["issue", "error", "lỗi"],
            "error": ["issue", "problem", "lỗi", "failed"],
            "failed": ["error", "issue", "không được"],
            "access": ["login", "permission", "truy cập", "quyền"],
            "login": ["sign in", "đăng nhập", "auth"],
